...
const QUESTIONS = [
  ...
  {
    q: '¿De qué material suelen estar hechos los robots más fuertes?',
    correct: 0,
    opts: ['De Metal', 'De Gelatina', 'De Algodón', 'De Chocolate']
  },
  {
    q: '¿Qué usan algunos robots voladores (drones) para elevarse?',
    correct: 1,
    opts: ['Alas de cartón', 'Las Hélices', 'Globos de agua', 'Cuerdas elásticas']
  },
  {
    q: '¿Qué herramienta usamos para apretar los tornillos del robot?',
    correct: 0,
    opts: ['El Destornillador', 'Un Tenedor', 'Una Goma de borrar', 'Un Peine']
  },
  {
    q: 'Si el motor del robot está muy caliente, ¿qué necesita para enfriarse?',
    correct: 3,
    opts: ['Un Abrigo', 'Una Estufa', 'Fuego', 'Un Ventilador']
  },
  {
    q: '¿Qué usan los robots para escuchar tu voz?',
    correct: 2,
    opts: ['Una Lupa', 'Una Rueda', 'Un Micrófono', 'Una Luz LED']
  },
  {
    q: '¿Qué usamos para manejar o mover el robot a distancia?',
    correct: 0,
    opts: ['Un Control Remoto', 'Un Plato', 'Una Maceta', 'Una Almohada']
  },
  {
    q: '¿Para qué le ponemos una cámara al robot?',
    correct: 3,
    opts: ['Para que huela flores', 'Para que pueda saltar', 'Para que coma', 'Para que pueda ver']
  },
  {
    q: '¿Cuál de estos NO es un robot?',
    correct: 1,
    opts: ['Un dron', 'Un perro de verdad', 'Un coche a control remoto', 'Un brazo mecánico']
  },
  {
    q: '¿Qué debemos hacer si la batería del robot está en rojo y parpadea?',
    correct: 0,
    opts: ['Ponerlo a cargar', 'Echarle agua', 'Esconderlo', 'Pintarlo de verde']
  },
  {
    q: '¿Qué usa un robot para emitir sonidos y hablar?',
    correct: 2,
    opts: ['Un Espejo', 'Un Zapato', 'Un Altavoz / Bocina', 'Una Rueda']
  },
  {
    q: '¿Cómo podemos proteger los cables eléctricos del robot?',
    correct: 1,
    opts: ['Poniéndolos en agua', 'Usando cinta aislante', 'Cortándolos', 'Dejándolos al sol']
  }
];
...
function safeLoadImage(primaryUrl, fallbackUrl) {
  ...
  img.onerror = () => {
    if (fallbackUrl && img.src !== fallbackUrl) {
      console.warn(`Fallback de imagen a CDN: ${fallbackUrl}`);
      img.src = fallbackUrl;
    } else {
      img.failed = true;
    }
...
function preloadAllGameImages() {
  // Pre-cargar todos los Pokémon seleccionables
  ...
  // Pre-cargar elementos de escenario local
  safeLoadImage('assets/scenery/tree_bot.svg');
  safeLoadImage('assets/scenery/gear_large.svg');
  safeLoadImage('assets/scenery/tech_pillar.svg');
}
